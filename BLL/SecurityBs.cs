   ...
   public class SecurityBs:BaseBs
    {
        ...
        //    userBs = new UserBs();UserDb db
        //    urlBs = new UrlBs();
        //}
    }
    public class CoreWebMembershipProvider : MembershipProvider
    {
        UserDb db;
        public CoreWebMembershipProvider()
        {
            db = new UserDb();
        }
    ...
    public class CoreWebRoleProvider : RoleProvider
    {
        UserDb db;
        public CoreWebRoleProvider()
        {
            db = new UserDb();
        }
        public override string ApplicationName { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
